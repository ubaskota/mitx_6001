...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        try:
            for i in lower_case:
                new_dic[i] = chr(((ord(i) + shift) - 97)% 26 + 97)
        except TypeError:
            print("Says TypeError")

        try:
            for i in upper_case:
                new_dic[i] = chr(((ord(i) + shift) - 65)% 26 + 65)
        except TypeError:
            print("Says TypeError again")
...
def decrypt_story():
    final_code = CiphertextMessage(get_story_string())
    return final_code.decrypt_message()
